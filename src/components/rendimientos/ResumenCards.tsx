...
const ResumenCards: React.FC<ResumenCardsProps> = ({
  ...
  const activosMasMoneda = valorActualTotal + saldosTotalUSD;
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
      ...
      {/* Cuenta 2: Rendimiento Total */}
      <div className="bg-slate-700/50 rounded-lg p-6">
        <h3 className="text-lg font-bold text-white mb-4">Rendimiento Total</h3>
        <table className="w-full text-sm">
          <tbody className="text-white">
            <tr>
              <td className="text-slate-300 py-1">Activos + Moneda</td>
              <td className="text-right text-slate-300 font-semibold py-1">{formatCurrency(activosMasMoneda)}</td>
            </tr>
            <tr>
